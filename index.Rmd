...
It is based on data and exampels seen in class 
Build on the excellent tutorial from [RStudio](https://rstudio.github.io/leaflet/)
...
- I would personal stick with the OSM, CartoDB, ESRI, and Stamen servers ...
